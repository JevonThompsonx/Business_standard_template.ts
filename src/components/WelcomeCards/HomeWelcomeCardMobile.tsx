const HomeWelcomeCardMobile = () => {
  return (
    <div className="aspect-square w-[90%] h-auto mx-auto  bg-[url(images/erik-brolin-wmZNEGkcsmw-unsplash.jpg)] bg-cover bg-center flex flex-col items-center justify-evenly rounded-2xl">
