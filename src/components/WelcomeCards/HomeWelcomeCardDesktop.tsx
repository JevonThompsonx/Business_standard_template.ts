const HomeWelcomeCardDesktop = () => {
  return (
    <div className="w-[90%] mx-auto h-auto aspect-video bg-[url(/images/Desktop/kaylee-garrett-GaprWyIw66o-unsplash.jpg)] bg-cover bg-center flex flex-col items-center justify-evenly rounded-2xl">
