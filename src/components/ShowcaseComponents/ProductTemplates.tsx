...
">
      ...
      <div id="buttonHome" className="flex flex-row justify-evenly shrink w-full">
        <button
      ...
      <div id="emptyspace" className="grow-8"></div>
      <div className="grow-1"></div>
...
const ProductTemplateWithEmail: React.FC<ButtonProps> = ({ ButtonText, Heading, Link }) => {
      ...
      <form onSubmit={handleSubmit} className="w-full flex flex-col items-center gap-4">
        ...
        <div className="w-full max-w-xs flex flex-col gap-2">
          <input
            ...
            className={`w-full px-4 py-2 rounded-lg border ${isValid ? 'border-white' : 'border-red-500'
          ...
          <button
            type="submit"
            className="w-full py-2.5 px-5 bg-white border border-white rounded-xl
                      text-black hover:bg-white/90 active:bg-white/80
                      transition-colors duration-200
                      focus:outline-none focus:ring-2 focus:ring-gray-900 focus:ring-offset-2"
          >
